...
function checkScoreUpdate(correctCount,secondsCount,roundNum) { console.log(secondsCount);
    ...
    if ( correctCount == sessionHighestScore && secondsCount < timeOfHighestScore) { timeOfHighestScore = secondsCount; }
    ...
    .then( resp => {  console.log(resp); }); // should be = "updated NEW history" OR "storedHistory""
