...
// Credit MIT Licence - https://www.cssscript.com/confetti-falling-animation/
...
(function() { console.log('in teacher table confetti drop');
	...
	function startConfettiInner() {
		...
		if (canvas === null) {
			...
			canvas.setAttribute("style", "display:block;z-index:999999;pointer-events:none;position:absolute;top:0vh;left:0vw;"); // Positioned for full screen
