...
function buttonFeedbackIncorrect(buttonId, isSolutionButton) {
    ...
    if (isSolutionButton === true) {
        ...
        document.getElementById(buttonId).removeEventListener('click', checkAnswer);       // Correct solution when clicked doesn't trigger the normal event but ONLY UNFREEZES
        document.getElementById(buttonId).addEventListener('click', pauseWrapper);            
    } else {
